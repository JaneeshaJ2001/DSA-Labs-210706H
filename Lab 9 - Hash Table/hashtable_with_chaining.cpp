...
struct HashTable{
	...
	//if the location is empty ,then simply print a message
    //otherwise go to the index which is given from the hash function and search from the linked list.
        if (empty){
            cout << "The user name you're searching is not stored .";
        }else{
